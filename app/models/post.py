...
def search_posts_paginated(query, limit=20, offset=0):
    """
    Retrieves a paginated list of posts matching a search query.

    @param query The search query string.
    @param limit The maximum number of posts to return (default 20).
    @param offset The number of posts to skip (default 0).
    @return A paginated list of matching post records.
    """
    db = get_db()
    pattern = f"%{query}%"
    return db.execute("""
